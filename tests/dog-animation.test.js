...
const actor={style:{},clientWidth:96,dataset:{sitReactionSrc:"sitReaction.png",walkStride:104/256,walkDuration:1.2,loopFps:20,transitionFps:20},classList:{add(){},remove(){}}};
...
tick();assert(sprite.style.backgroundImage.includes('sitReaction'),'seated petting wags tail without changing pose');
