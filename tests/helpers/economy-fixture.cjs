...
function fixture(){
 ...
 for(const name of ['getMedalLevel','getMedalShopMult','getYardStageMult','getPrestigeMult','getVipMult','getTrainingSum','getTrainingAllIncomeMult','isPackCatOwned','getCardSum','getCardOrePerSec','getItemMult','getClickPctMult','getEnergyClickMult','getClickPower','getIdleMult','getOrePerSec','economyRate','creditBones','seededRand','makeQuestReward','generateQuests','ensureQuests','ensureDailyGoals','bumpQuest','claimQuest','normalizeCare','ensureCareDay','getCareInfo','getCareBonus','addCareTrust','noteCarePetting','noteCareWalk','noteCareEvent','activityReward','isWalkUnlocked','explorationQuote','startWalk','walkRewardBones','completeWalk','serialize','isUpgradeUnlocked','isCardUnlocked','cardNeedList','isPackCardOpen','cardMaxLevel','upgradeCost','cardCost'])vm.runInContext(fn(name),ctx);
