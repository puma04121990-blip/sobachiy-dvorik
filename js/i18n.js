...
(function (root) {
  ...
  var UI = {
    ru: {
      ...
      request_buy: "Обустроим двор",
      request_earn: "Запас для дворика",
      request_events: "Поиграем вместе",
      request_walks: "Свежий воздух",
      request_clicks: "Минутка ласки",
      request_to_yard: "К собачке",
      requests_done: "Выполнено и получено: {n}/3",
      requests_explained: "Три небольших дела с собакой. Прогресс считается автоматически, косточки нужно забрать кнопкой. Полный план дополнительно укрепляет доверие; пропуск не отнимает косточки и открытия.",
      train_failed: "Последовательность не получилась. Награда не начислена. В следующий раз попробуй запомнить команды как короткую историю.",
      train_next: "Верно! Какая команда следующая?",
      train_one_error: "Не та команда. Осталась одна попытка — продолжай с того же места.",
      catch_miss: "Мимо. На следующем броске нажми в зелёной зоне.",
      catch_hit: "Поймал! Дождись следующего броска.",
      catch_ready: "Шесть бросков. На каждый — одна попытка.",
      activity_result: "Результат игры",
      achievement_notice: "🏆 Выполнено: «{name}». Доступно наград: {count}. Нажми, чтобы забрать.",
      trust_title: "Доверие",
      trust_h: "Доверие · уровень {n}",
      trust_desc: "Растёт за живую заботу: почесушки, прогулки, игры и закрытый план дня. Уровень усиливает награды прогулок и мини-игр.",
      trust_bonus: "Бонус к прогулкам и играм: +{n}%. До следующего уровня: {next}.",
      trust_max: "максимум",
      trust_pet: "поглаживания",
      trust_walk: "прогулки",
      trust_game: "игры",
      trust_pet_action: "К собачке",
      trust_level_up: "Доверие выросло до уровня {n}! 🤝",
      optional_requests: "План заботы на сегодня",
      exploration_progress: "Исследование: {count}/{next} · открыто {found}/5",
      exploration_empty: "Здесь ещё нет воспоминаний. Первое открытие уже близко.",
      exploration_next: "Следующее место: {name}",
      exploration_complete: "Маршрут изучен!",
      exploration_found: "Новое место в дневнике!",
      exploration_quote: "+{n} к исследованию",
      exploration_bonus: "В награде учтено +{n} за открытие",
      discovery_bench: "Тёплая скамейка",
      discovery_cat: "Знакомый кот",
      discovery_fountain: "Питьевой фонтанчик",
      discovery_courtyard: "Тихий двор",
      discovery_home: "Любимая дорога домой",
      discovery_oak: "Старый дуб",
      discovery_ducks: "Утиный пруд",
      discovery_bridge: "Деревянный мостик",
      discovery_meadow: "Поляна для игр",
      discovery_friends: "Место встречи друзей",
      discovery_tracks: "Звериные следы",
      discovery_stream: "Лесной ручей",
      discovery_hill: "Сосновый холм",
      discovery_lake: "Скрытое озеро",
      discovery_overlook: "Вид на весь район",
      ...
      save: 'Сохранить',
      walk_meta: "Прогулки дают серьёзные косточки, находки и доверие",
      sections: 'Разделы',
      tab_shop: 'Магазин',
      tab_cards: 'Стая',
      ...
      cards_hint: "Первая карточка каждой ветки доступна без покупки ветки. Остальные — после покупки за реальные деньги. Уровни карточек покупаются за косточки.",
      cat_crew: 'Команда',
      cat_district: 'Район',
      cat_special: 'Особые',
      ...
      quests_h: "Дневник прогулок",
      quests_hint: "Доверие растёт от заботы, прогулок и игр. Запахи быстрее открывают места, пройденный маршрут даёт больше косточек. Новое место добавляет 25% к награде, знакомый путь требует меньше энергии.",
      ach_h: 'Достижения',
      ach_hint: "Каждая награда фиксирована и выдаётся один раз. Сумма не зависит от дохода или бустов. Выполни условие и нажми «Забрать».",
      ...
      toy_hint: "Шесть бросков, по одной попытке. Нажми, когда мяч в зелёной зоне.",
      toy_taps: "Поймано:",
      toy_find: "ЛОВИ!",
      toy_reward: "За 6 попаданий — полная награда. Результат появится после игры.",
      train_title: 'Дрессировка',
      train_hint: "Запомни три команды и повтори их по порядку. Вторая ошибка завершает игру.",
      story_ch: 'Глава',
      next: 'Далее',
      hide_title: 'Прятки',
      ...
      help_1: "Нажимай на собачку или пробел — каждое нажатие даёт косточки. Усталость уменьшает доход, но не блокирует клики.",
      ...
      help_6: "В «Стае» первая карточка каждой ветки доступна бесплатно. Остальные открываются покупкой ветки за реальные деньги; уровни покупаются за косточки.",
      help_ok: 'Понятно',
    ...
    en: {
      ...
      request_buy: "Improve the yard",
      request_earn: "Supplies for the yard",
      request_events: "Let’s play together",
      request_walks: "Fresh air",
      request_clicks: "A moment of affection",
      request_to_yard: "Visit your dog",
      requests_done: "Completed and claimed: {n}/3",
      requests_explained: "Three small activities with your dog. Progress is automatic; claim bones with the button. A full plan also builds trust; skipping loses no bones or discoveries.",
      train_failed: "Sequence incomplete. No reward earned. Next time, link the commands into a short story.",
      train_next: "Correct! Which command is next?",
      train_one_error: "Wrong command. One attempt left — continue from the same position.",
      catch_miss: "Missed. Tap in the green zone on the next throw.",
      catch_hit: "Caught! Wait for the next throw.",
      catch_ready: "Six throws. One attempt per throw.",
      activity_result: "Game result",
      achievement_notice: "🏆 Completed: “{name}”. {count} rewards ready. Tap to claim.",
      trust_title: "Trust",
      trust_h: "Trust · level {n}",
      trust_desc: "Grows through real care: petting, walks, games and a finished daily plan. The level boosts walk and mini-game rewards.",
      trust_bonus: "Walk and game bonus: +{n}%. Next level in: {next}.",
      trust_max: "max",
      trust_pet: "petting",
      trust_walk: "walks",
      trust_game: "games",
      trust_pet_action: "To the dog",
      trust_level_up: "Trust reached level {n}! 🤝",
      optional_requests: "Today’s care plan",
      exploration_progress: "Exploration: {count}/{next} · discoveries {found}/5",
      exploration_empty: "No memories here yet. Your first discovery is close.",
      exploration_next: "Next place: {name}",
      exploration_complete: "Route explored!",
      exploration_found: "New place in your journal!",
      exploration_quote: "+{n} exploration",
      exploration_bonus: "Includes +{n} discovery bonus",
      discovery_bench: "Sunny bench",
      discovery_cat: "Familiar cat",
      discovery_fountain: "Drinking fountain",
      discovery_courtyard: "Quiet courtyard",
      discovery_home: "Favourite way home",
      discovery_oak: "Old oak",
      discovery_ducks: "Duck pond",
      discovery_bridge: "Wooden bridge",
      discovery_meadow: "Play meadow",
      discovery_friends: "Friends meeting spot",
      discovery_tracks: "Animal tracks",
      discovery_stream: "Forest stream",
      discovery_hill: "Pine hill",
      discovery_lake: "Hidden lake",
      discovery_overlook: "View of the neighbourhood",
      ...
      save: 'Save',
      walk_meta: "Walks bring serious bones, discoveries and trust",
      sections: 'Sections',
      tab_shop: 'Shop',
      tab_cards: 'Pack',
      ...
      payback_taps: '~{n} taps',
      cards_h: 'Yard pack',
      cards_hint: "The first card of each branch is available without purchasing the branch. Other cards require a real-money purchase. Card levels cost bones.",
      cat_crew: 'Crew',
      ...
      quests_h: "Walk journal",
      quests_hint: "Trust grows from care, walks and games. Sniffing reveals places faster; trail walks earn more bones. Discoveries add 25% to the reward; familiar routes use less energy.",
      ach_h: 'Achievements',
      ach_hint: "Each reward is fixed and can be claimed once. Income and boosts do not change it. Complete the goal, then claim.",
      story_h: 'Yard story',
      ...
      toy_hint: "Six throws, one attempt each. Tap when the ball is in the green zone.",
      toy_taps: "Caught:",
      toy_find: "CATCH!",
      toy_reward: "Six catches earn the full reward. Results appear after the game.",
      train_title: 'Training',
      train_hint: "Remember three commands and repeat them in order. A second mistake ends the game.",
      story_ch: 'Chapter',
      next: 'Next',
      ...
      help_1: "Tap your dog or press Space — every tap earns bones. Fatigue reduces income but does not block taps.",
      ...
      help_6: "In Pack, the first card of each branch is free to access. Other cards require a real-money branch purchase; levels cost bones.",
      help_ok: 'Got it',
