...
(function (root) {
  ...
  var UI = {
    ru: {
      ...
      requests_explained: "Три небольших дела с собакой. Прогресс считается автоматически, косточки нужно забрать кнопкой. Обновление в полночь по Владивостоку; пропуск не отнимает косточки и открытия.",
      ...
      quests_hint: "Исследуй три маршрута. Запахи дают больше открытий, пройденный маршрут — больше косточек. Каждое новое место добавляет 25% к награде; знакомый путь требует меньше энергии. Прогресс не сбрасывается на выставке.",
      ach_h: 'Достижения',
    ...
    en: {
      ...
      requests_explained: "Three small activities with your dog. Progress is automatic; claim bones with the button. Resets at midnight Vladivostok time. Skipping loses no bones or discoveries.",
      ...
      quests_hint: "Explore three routes. Sniffing reveals places faster; trail walks earn more bones. Discoveries add 25% to the reward; familiar routes use less energy. Progress survives shows.",
      ach_h: 'Achievements',
