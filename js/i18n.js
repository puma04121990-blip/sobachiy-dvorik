...
(function (root) {
  ...
  var UI = {
    ru: {
      ...
      boost: 'x2 буст',
      item: 'Предмет',
      pet_aria: 'Погладить собачку',
      play_after_walk: 'Поиграем после прогулки',
      hide_watch: "Запомни, где лежит косточка.",
      branch_special: "Откроется на этапе двора 2",
      branch_district: "Откроется после 2 игр",
      branch_crew: "Откроется после 2 прогулок",
      pet_tired: "Собачка устала. Дай ей отдохнуть.",
      pet_away: "Собачка на прогулке — погладим после возвращения.",
      walk_ready_reward: "Собачка вернулась · +{n} 🦴",
      walk_sniff: "Исследовать запахи",
      walk_trail: "Пройти маршрут",
      walk_quote: "{mins} мин · ⚡{energy} · +{reward} 🦴 · находка {chance}%",
      pet_btn: "ПОГЛАДИТЬ",
      first_hint: "Нажми на собачку, чтобы погладить · или пробел",
      energy: 'Энергия',
      ...
      save: 'Сохранить',
      walk_meta: "Маршруты на 1–4 мин · косточки или находки",
      sections: 'Разделы',
      tab_shop: 'Магазин',
      tab_cards: 'Стая',
      ...
      cards_hint: "Помощники открываются через прогулки, игры и развитие двора. Покупка уровня увеличивает постоянный доход.",
      cat_crew: 'Команда',
      cat_district: 'Район',
      cat_special: 'Особые',
      ...
      quests_hint: "Три задания в день: забота, прогулки и игры. Награды не выполняют другие задания.",
      ach_h: 'Достижения',
      ...
      event_bang: 'Событие!',
      play: 'Играть',
      toy_title: "Поймай мяч!",
      toy_hint: "Нажми, когда мяч в зелёной зоне. Между попытками — 1 секунда.",
      toy_taps: "Поймано:",
      toy_find: "ЛОВИ!",
      toy_reward: "Точность важнее скорости. Шесть попаданий — полная награда.",
      train_title: 'Дрессировка',
      train_hint: 'Запомните команду и повторите!',
      story_ch: 'Глава',
      next: 'Далее',
      hide_title: 'Прятки',
      hide_hint: "Запомни косточку и найди её после закрытия карточек.",
      hide_tries: 'Попыток:',
      walk_sheet: "Куда пойдём?",
      walk_sheet_hint: "Выбери цель прогулки. Нужна энергия; косточки за выход не списываются.",
      race_title: 'Гонка за белкой',
      race_hint: "Держи ровный темп: примерно одно нажатие каждые 0,6 секунды.",
      race_score: 'Ритм:',
      race_tap: 'ТАП!',
      race_keep: "Слишком частые нажатия сбивают ритм.",
      help_1: "Погладь собаку — получи косточки. Спокойный темп: не чаще двух раз в секунду.",
      help_2: "Ласка и прогулки расходуют энергию. Во время прогулки собачка недоступна.",
      help_3: 'Магазин, стая и дрессировка усиливают почесушки и автодоход — кости капают сами, даже без кликов.',
      help_4: "Выбери маршрут: больше косточек или больше шансов найти наклейку. Доход известен заранее.",
      help_5: 'Выставка сбрасывает апгрейды за медальки навсегда.',
      help_6: "Открывай стаю прогулками и играми. Карточки дают постоянный доход, а не разовую награду за покупку.",
      help_ok: 'Понятно',
      ...
      event_ready: "Поиграть!",
      event_cd: 'Событие ~{n}м',
      event_not_ready: 'Событие ещё не готово 🐾',
      toy_found: "Отличная игра! +{n} 🦴 · попаданий: {taps}",
      ...
      daily_h: "Прежние задания — можно завершить сегодня",
      ...
      noads_bonus: "Автодоход ×2 на минуту.",
      ad_bonus: "Автодоход ×2 на минуту. Награды прогулок и заданий не меняются.",
      saved: 'Сохранено 💾',
      ...
      pet_hint_toast: "Познакомься с собакой: погладь её и выбери первую прогулку.",
    ...
    en: {
      ...
      play_after_walk: 'Play after the walk',
      hide_watch: "Remember where the bone is.",
      branch_special: "Unlocks at yard stage 2",
      branch_district: "Unlocks after 2 games",
      branch_crew: "Unlocks after 2 walks",
      pet_tired: "Your dog is tired. Let them rest.",
      pet_away: "Your dog is out walking. Pet them when they return.",
      walk_ready_reward: "Your dog is back · +{n} 🦴",
      walk_sniff: "Sniff and explore",
      walk_trail: "Trail",
      walk_quote: "{mins} min · ⚡{energy} · +{reward} 🦴 · discovery {chance}%",
      pet_btn: "PET",
      first_hint: "Tap your dog to pet them · or press Space",
      energy: 'Energy',
      ...
      save: 'Save',
      walk_meta: "1–4 min routes · bones or discoveries",
      sections: 'Sections',
      tab_shop: 'Shop',
      tab_cards: 'Pack',
      ...
      payback_taps: '~{n} taps',
      cards_h: 'Yard pack',
      cards_hint: "Unlock helpers through walks, games and yard progress. Upgrading increases steady income.",
      cat_crew: 'Crew',
      ...
      quests_hint: "Three daily tasks: care, walks and play. Bonus rewards do not complete other tasks.",
      ach_h: 'Achievements',
      ...
      event_bang: 'Event!',
      play: 'Play',
      toy_title: "Catch the ball!",
      toy_hint: "Tap when the ball is in the green zone. Wait one second between attempts.",
      toy_taps: "Caught:",
      toy_find: "CATCH!",
      toy_reward: "Accuracy beats speed. Six catches earn the full reward.",
      train_title: 'Training',
      train_hint: 'Remember the command and repeat it!',
      story_ch: 'Chapter',
      next: 'Next',
      hide_title: 'Hide and seek',
      hide_hint: "Remember the bone, then find it after the cards turn over.",
      hide_tries: 'Tries:',
      walk_sheet: "Where shall we go?",
      walk_sheet_hint: "Choose your walk goal. Uses energy, with no bone entry fee.",
      race_title: 'Squirrel race',
      race_hint: "Keep a steady pace: one tap roughly every 0.6 seconds.",
      race_score: 'Rhythm:',
      race_tap: 'TAP!',
      race_keep: "Tapping too fast breaks the rhythm.",
      help_1: "Pet your dog for bones. A gentle pace: at most twice a second.",
      help_2: "Petting and walks use energy. Your dog is away during a walk.",
      help_3: 'Shop, pack and training boost pets and idle income — bones drip on their own, even without tapping.',
      help_4: "Choose a route: more bones or a better sticker chance. The reward is quoted upfront.",
      help_5: 'A dog show resets upgrades for permanent medals.',
      help_6: "Unlock pack branches through walks and play. Cards provide steady income, not purchase rewards.",
      help_ok: 'Got it',
      ...
      toy_found: "Good game! +{n} 🦴 · catches: {taps}",
      ...
      daily_h: "Previous tasks — finish them today",
      max_lvl: 'Max level',
      ...
      noads_bonus: "Double idle income for one minute.",
      ad_bonus: "Double idle income for one minute. Walk and quest rewards stay the same.",
      saved: 'Saved 💾',
      ...
      pet_hint_toast: "Meet your dog: pet them and choose your first walk.",
  ...
  function questLabel(type, n) {
    if (type === 'walks' || type === 'events') return dailyLabel(type, n);
    if (lang === 'en') {
