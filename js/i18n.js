...
(function (root) {
  ...
  var UI = {
    ru: {
      ...
      season_banner: 'Осенний фестиваль · жёлуди в сезоне!',
      season_go: 'В сезон',
      ...
      help_6: 'Стая — как в Хомяке: каждый уровень даёт плюс к автодоходу. Поздние дела кормят лучше ранних.',
      help_ok: 'Понятно',
    ...
    en: {
      ...
      season_banner: 'Autumn festival · acorns in season!',
      season_go: 'To season',
      ...
      help_6: 'The pack works like Hamster Kombat: each level adds idle income. Later entries feed you better.',
      help_ok: 'Got it',
