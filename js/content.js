...
const BREEDS = {
  lab: { id: 'lab', name: 'Лабрадор', desc: 'Сбалансированный старт', src: 'assets/dog-click.webp', walkSrc: 'assets/dog-lab-walk.webp', sitSrc: 'assets/dog-lab-sit.webp', walkFrames: 4, frameW: 192, frameH: 192, unlockCost: 0, bonuses: { clickMult: 1, idleMult: 1, comboWindowBonus: 0 }, startUnlocked: true },
  corgi: { id: 'corgi', name: 'Корги', desc: '+5% к почесушкам', src: 'assets/dog-corgi.webp', walkSrc: 'assets/dog-corgi-walk.webp', sitSrc: 'assets/dog-corgi-sit.webp', walkFrames: 4, frameW: 192, frameH: 192, unlockCost: 35000, reqLifetime: 1e5, bonuses: { clickMult: 1.05, idleMult: 1, comboWindowBonus: 0 }, startUnlocked: false },
  husky: { id: 'husky', name: 'Хаски', desc: '+5% к автодоходу', src: 'assets/dog-husky.webp', walkSrc: 'assets/dog-husky-walk.webp', sitSrc: 'assets/dog-husky-sit.webp', walkFrames: 4, frameW: 192, frameH: 192, unlockCost: 140000, reqLifetime: 5e5, bonuses: { clickMult: 1, idleMult: 1.05, comboWindowBonus: 0 }, startUnlocked: false },
  dachshund: { id: 'dachshund', name: 'Такса', desc: '+200 мс к окну комбо', src: 'assets/dog-dachshund.webp', walkSrc: 'assets/dog-dachshund-walk.webp', sitSrc: 'assets/dog-dachshund-sit.webp', walkFrames: 4, frameW: 192, frameH: 192, unlockCost: 450000, reqLifetime: 2.5e6, reqMedals: 1, bonuses: { clickMult: 1, idleMult: 1, comboWindowBonus: 200 }, startUnlocked: false },
  shiba: { id: 'shiba', name: 'Сиба', desc: '+4% к почесушкам и +2% к автодоходу', src: 'assets/dog-shiba.webp', walkSrc: 'assets/dog-shiba-walk.webp', sitSrc: 'assets/dog-shiba-sit.webp', walkFrames: 4, frameW: 192, frameH: 192, unlockCost: 1.2e6, reqLifetime: 6e6, reqMedals: 2, bonuses: { clickMult: 1.04, idleMult: 1.02, comboWindowBonus: 0 }, startUnlocked: false },
  poodle: { id: 'poodle', name: 'Пудель', desc: '+8% к автодоходу', src: 'assets/dog-poodle.webp', walkSrc: 'assets/dog-poodle-walk.webp', sitSrc: 'assets/dog-poodle-sit.webp', walkFrames: 4, frameW: 192, frameH: 192, unlockCost: 2.8e6, reqLifetime: 2.5e7, reqMedals: 3, bonuses: { clickMult: 1, idleMult: 1.08, comboWindowBonus: 0 }, startUnlocked: false },
  beagle: { id: 'beagle', name: 'Бигль', desc: '+6% к почесушкам · +80 мс комбо', src: 'assets/dog-beagle.webp', walkSrc: 'assets/dog-beagle-walk.webp', sitSrc: 'assets/dog-beagle-sit.webp', walkFrames: 4, frameW: 192, frameH: 192, unlockCost: 7e6, reqLifetime: 8e7, reqMedals: 5, bonuses: { clickMult: 1.06, idleMult: 1, comboWindowBonus: 80 }, startUnlocked: false },
};
